...
func (e *API) V0CapabilitiesDisclosure(w http.ResponseWriter, r *http.Request) {
	...
	capabilities = append(capabilities, "adjust-server-cpus, /api/m3s/v0/server/cpus/{cpus}, PUT")
	capabilities = append(capabilities, "adjust-server-cpus-limit, /api/m3s/v0/server/cpusLimit/{cpus}, PUT")
	capabilities = append(capabilities, "adjust-agent-cpus, /api/m3s/v0/agent/cpus/{cpus}, PUT")
	capabilities = append(capabilities, "adjust-agent-cpus-limit, /api/m3s/v0/agent/cpusLimit/{cpus}, PUT")
	capabilities = append(capabilities, "adjust-ds-cpus, /api/m3s/v0/ds/cpus/{cpus}, PUT")
	capabilities = append(capabilities, "adjust-ds-cpus-limit, /api/m3s/v0/ds/cpusLimit/{cpus}, PUT")
	capabilities = append(capabilities, "adjust-server-memory, /api/m3s/v0/server/memory/{memory}, PUT")
	capabilities = append(capabilities, "adjust-server-memory-limit, /api/m3s/v0/server/memoryLimit/{memory}, PUT")
	capabilities = append(capabilities, "adjust-agent-memory, /api/m3s/v0/agent/memory/{memory}, PUT")
	capabilities = append(capabilities, "adjust-agent-memory-limit, /api/m3s/v0/agent/memoryLimit/{memory}, PUT")
	capabilities = append(capabilities, "adjust-ds-memory, /api/m3s/v0/ds/memory/{memory}, PUT")
	capabilities = append(capabilities, "adjust-ds-memory-limit, /api/m3s/v0/ds/memoryLimit/{memory}, PUT")
	capabilities = append(capabilities, "adjust-server-disk, /api/m3s/v0/server/disk/{disk}, PUT")
	capabilities = append(capabilities, "adjust-server-disk-limit, /api/m3s/v0/server/diskLimit/{disk}, PUT")
	capabilities = append(capabilities, "adjust-agent-disk, /api/m3s/v0/agent/disk/{disk}, PUT")
	capabilities = append(capabilities, "adjust-agent-disk-limit, /api/m3s/v0/agent/diskLimit/{disk}, PUT")

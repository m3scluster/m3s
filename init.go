...
func init() {
	...
	config.K3SAgentMax, _ = strconv.Atoi(os.Getenv("K3S_AGENT_COUNT"))
	config.K3SServerMax, _ = strconv.Atoi(os.Getenv("K3S_SERVER_COUNT"))
	...
	config.K3SCustomString = os.Getenv("K3S_CUSTOM_DOMAIN")
